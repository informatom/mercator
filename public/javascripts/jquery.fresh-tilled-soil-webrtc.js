...
(function ($, window, document, undefined) {
    ...
    var settings = {
        ...
        rtcStatusUpdate: {
            ...
            "entry": {
                statusHTML: 'Bitte lassen Sie den Kanalname unverändert, <br>sofern Ihnen der Supportmitarbeiter nicht einen anderen Kanalnamen mitgeteilt hat!' + '<input id="videoChannelInput" class="video-channel-input" type="text" value="Supportkanal 1" />' + '<button id="videoChatStartButton" class="video-chat-start-button">Videochat starten</button>',
                statusFx: function ($this, statusType) { // displays channel entry form
                    ...
                    $('#videoChatStartButton').off().on('click', function () {
                        ...
                        if ($channelInput.val().length <= 0) {
                            alert('Bitte tragen Sie einen Kanalnamen ein, um fortzusetzen!');
                            $channelInput.focus();
                        } else {
            ...
            "allow": {
                statusHTML: "Bitte klicken Sie auf 'Zulassen',<br>um Video- und Audio zu senden",
                statusFx: function ($this, statusType) { // handle media capture note to click allow/share devices
                    ...
                    if (isMoz) {
                        $this.opts.rtcStatusUpdate.allow.statusHTML = "Bitte klicken Sie 'Freigegebene Geräte auswählen',<br>um Video- und Audio zu senden";
                    }
            ...
            "waiting": {
                statusHTML: "Kanal: <strong>{{channel_name}}</strong> <span class='exit-channel'>(<a href='#' class='exit-channel-link'>Kanal verlassen</a>)</span><br>Wartet auf einen Konversationspartner...",
            ...
            "connecting": {
                statusHTML: "Parter gefunden, Verbindung wird hergestellt...",
            ...
            "connected": {
                statusHTML: '<button id="videoChatHangupButton" class="video-chat-hangup-button">Auflegen</button>',
