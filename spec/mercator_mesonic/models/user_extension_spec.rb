...
describe User do
  before :each do
    @user = create(:user, erp_account_nr: "691801-2004-1404")
    create(:country)
  ...
  describe "update_erp_account_nr" do
    before :each do
      @user.update(erp_contact_nr: "10000-2004-1404",
                   erp_account_nr: nil)
    end
    ...
    it "fixes the erp account number" do
      @user.update_erp_account_nr
      expect(@user.erp_account_nr).to eql "112452-2004-1404"
    end
  end
  ...
  describe "update_business_year" do
    it "updates the business year" do
      ...
      @user.update_business_year()
      expect(@user.erp_contact_nr).to eql "123456-1234-1404"
      expect(@user.erp_account_nr).to eql "123456-1234-1404"
    end
  end
end